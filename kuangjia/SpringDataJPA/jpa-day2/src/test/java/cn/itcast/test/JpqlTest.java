...
public class JpqlTest {
    ...
    @Test
    public void demo1(){
        List<Customer> list = customerDao.gqb_findJpql ( "北京" );
        System.out.println (list);
    }

    @Test
    public void demo2(){
        List<Customer> list = customerDao.gqb_findCustAddressAndCustIndustry ( "北京" ,"上海");
        System.out.println ("<<<<<<<<<<<<<<<<<<<<<<<<");
        System.out.println (list);
        System.out.println (">>>>>>>>>>>>>>>>>>>>>>>>>>");
    ...
    public void testUpdateCustomer() {
        customerDao.updateCustomer(4l,"黑马程序员111");
    }
    ...
    @Rollback(value = false)
    public void demo3(){
        customerDao.gqb_updateCustomer ( "15338826129","北京" );
        System.out.println ("<<<<<<<<<<<<<<<<<<<<<<<<");
        System.out.println (">>>>>>>>>>>>>>>>>>>>>>>>>>");
    ...
    @Test
    public void demo4(){
        List<Object[]> list = customerDao.gqb_findsql ( "传智播客%" );
        System.out.println ("<<<<<<<<<<<<<<<<<<<");
        for (Object [] obj:list
             ) {
            System.out.println (Arrays.toString ( obj ));
    ...
    @Test
    public void demo5(){
        List<Customer> list = customerDao.findByCustAddress ( "北京" );
        System.out.println ("<<<<<<<<<<<<<<<<<<<");
        System.out.println (list);
        System.out.println (">>>>>>>>>>>>>>>>>>");
