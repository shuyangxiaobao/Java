...
//                "utf-8&qrst=1&rt=1&stop=1&vt=2&wq" +
...
//
//            String attr = spuEle.attr ( "data-sku" );
//            if (attr.length () < 2) {
//                continue;
//            }
//            //获取spu
...
//                String title = Jsoup.parse ( itemInfo ).select ( "div.p-name" ).text ();
//
//
//                title = skuEle.select ( "div.p-name" ).first ().text ();
