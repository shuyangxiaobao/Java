package day09_字节流_字符流.demo07.Prop;
...
//        show03();
    ...
    private static void xlp(){
        ...
        properties.setProperty ( "tom","19" );
        properties.setProperty ( "height","165" );
        Set<String> names = properties.stringPropertyNames ();

        FileWriter writer = null;
        try {
            writer = new FileWriter ( "/Users/xiaobao/Desktop/test/f3.txt" );
        } catch (IOException e) {
            e.printStackTrace ();
        }
        ...
        try {
            outputStream = new FileOutputStream ( "/Users/xiaobao/Desktop/test/f4.txt" );

            properties.store ( outputStream,"1234abcd好");
        } catch (IOException e) {
            e.printStackTrace ();
        }
