...
public class JobProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        //css选择器
        page.putField("div", page.getHtml().css("div#J_cate li.cate_menu_item").all());
...
//
//        获取链接
        page.addTargetRequests(page.getHtml().css("div#J_cate").links().regex(".*jd.*").all());
...
//        page.addTargetRequest("https://www.jd.com/news.html?id=37319");
    ...
    public static void main(String[] args) {
        Spider spider = Spider.create(new JobProcessor())
                ...
                .addPipeline(new FilePipeline("/Users/xiaobao/Desktop/pachong/html"))
                .thread(5)
